...
void playGame(node ***board, int numBlack, int numWhite, int numVac, int capBlack, int capWhite, float timeLeft, string player, string opp, int startI, int startJ, int numC);
...
int main(){
    ...
    playGame(board, numBlack, numWhite, numVacant, capturedBlack, capturedWhite, timeLeft, player, opponent, startI, startJ, numC);
...
void playGame(node ***board, int numBlack, int numWhite, int numVac, int capBlack, int capWhite, float timeLeft, string player, string opp, int startI, int startJ, int numC){
    ...
    int a = INT_MIN;
    int b = INT_MAX;
    pair<int, node*> move = runMinMax(board, player, player, opp, a, b, depth, numWhite, numBlack, capWhite, capBlack, startI, startJ, numC);
    if(move.first == 0){
